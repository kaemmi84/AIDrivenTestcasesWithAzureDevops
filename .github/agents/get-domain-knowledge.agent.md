...
5. Each Feature context file must include:
   1) Feature summary
   2) A concise but complete functional context (what the feature does, key rules, important states)
   3) A list of linked User Stories and their acceptance criteria
